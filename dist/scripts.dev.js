...
document.body.addEventListener('change', function (e) {
  ...
  switch (target.id) {
    ...
    case 'sms':
      ...
      document.getElementById('voice').parentNode.classList.remove('active');
      document.getElementById('email').parentNode.classList.remove('active');
      document.getElementById('sms').parentNode.classList.add('active'); //document.getElementById('btnVerify').disabled = false;
    ...
    case 'voice':
      ...
      document.getElementById('sms').parentNode.classList.remove('active');
      document.getElementById('email').parentNode.classList.remove('active');
      document.getElementById('voice').parentNode.classList.add('active'); //document.getElementById('btnVerify').disabled = false;
    ...
    case 'email':
      ...
      document.getElementById('voice').parentNode.classList.remove('active');
      document.getElementById('sms').parentNode.classList.remove('active');
      document.getElementById('email').parentNode.classList.add('active'); //document.getElementById('btnVerify').disabled = false;
